...
public class SubjectController {
    ...
    @GetMapping
    public ResponseEntity<List<SubjectDTO>> getSubjects(@RequestParam(required = false) String name, @RequestParam(required = false) Integer page, @RequestParam(required = false) Integer size) {
    ...
    @GetMapping("/cache")
    public ResponseEntity<List<SubjectDTO>> getCachedSubjects() {

...
public class AuthController {
    ...
    public ResponseEntity<Void> patchResetPassword(@PathVariable @NotBlank(message = "Token é obrigatório") String token, @RequestBody @Valid UpdatePasswordRequestDTO data) {
